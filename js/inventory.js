...
function buildInventoryList(data) {
    ...
    data.forEach(function (element) {
        ...
        dataTable += `<td><a href='/phpmotors/vehicles?action=mod&invId=${element.invId}' title='Click to modify' class='text-underline'>Modify</a></td>`;
        dataTable += `<td><a href='/phpmotors/vehicles?action=del&invId=${element.invId}' title='Click to delete' class='text-underline'>Delete</a></td></tr>`;
    })
    dataTable += '</tbody>';
